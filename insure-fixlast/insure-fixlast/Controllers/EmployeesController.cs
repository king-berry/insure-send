...
namespace insure_fixlast.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var insure_fixlastContext = _context.Employee.Include(e => e.Company);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Phone,Role,CompanyId")] Employee employee)
        {
            if (true)
            {
